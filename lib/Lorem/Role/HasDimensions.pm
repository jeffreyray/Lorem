...
use Lorem::Types qw(GiDocStyleDimension GiDocStyleLength GiDocStyleRelativeLength);
...
method _apply_dimension_style ( $style ) {
    ...
    #    if ( $style->width ) {
    #    if ( is_GiDocStyleRelativeLength( $style->width ) ) {
    ...
    #
    #if ( $style->height ) {
    #    if ( is_GiDocStyleRelativeLength( $style->height ) ) {
